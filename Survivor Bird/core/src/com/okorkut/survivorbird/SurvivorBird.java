package com.okorkut.survivorbird;
...
public class SurvivorBird extends ApplicationAdapter {
	/**
	 * Sprite çizmek için yardımcı objeler
	 */
	SpriteBatch batch;
	Texture background;
	Texture bird;
   ...
   // float enemyX = 0f; //düşman x kordinatı
	//Texture img;

    int numberOfEnemies = 4;
    float[] enemyX =  new float[numberOfEnemies]; //düşman x kordinatı
    float distance = 0f;
	...
	/**
	 * Oyun devam ettiği sürece devamlı çalıştırılan bir metot
	 */
	@Override
	public void render () {
        batch.begin();
